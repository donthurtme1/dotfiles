...
if get(g:, 'cpp_function_highlight', 1)
	...
	"syn match cUserFunctionArg "\<\h\w*"
    hi def link cUserFunction Function
    hi def link cUserFunctionPointer Function
	hi def link cUserFunctionArg Constant
endif


syn match cBold "\<[A-Z_][A-Z_0-9]\{1,}\>"
hi def link cBold String
...
if get(g:, 'cpp_member_highlight', 0)
    ...
    hi def link cStructMember Type
	hi def link cMemberAccess cOperator
